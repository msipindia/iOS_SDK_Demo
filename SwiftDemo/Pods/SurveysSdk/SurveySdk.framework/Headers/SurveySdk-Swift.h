...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SurveySdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9SurveySdk21HorizontalProgressBar")
...
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull frameColor;
@property (nonatomic) IBInspectable CGFloat frameBold;
@property (nonatomic) IBInspectable CGFloat pgHeight;
@property (nonatomic) IBInspectable CGFloat pgWidth;
...
SWIFT_CLASS("_TtC9SurveySdk13SurveyManager")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9SurveySdk10SurveyView")
...
@interface SurveyView (SWIFT_EXTENSION(SurveySdk)) <WKScriptMessageHandler>
...
@interface SurveyView (SWIFT_EXTENSION(SurveySdk)) <WKNavigationDelegate, WKUIDelegate>
